package com.uk.ninja.qa.gusudoku;
...
public class Game extends Activity {
	...
	private int puzzle[];
	private com.uk.ninja.qa.gusudoku.PuzzleView puzzleView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		calculateUsedTiles();
		puzzleView = new com.uk.ninja.qa.gusudoku.PuzzleView(this);
	...
	protected void showKeypadOrError(int x, int y) {
		...
		if (tiles.length == 9) {
			...
			Dialog v = new com.uk.ninja.qa.gusudoku.Keypad(this, tiles, puzzleView);
			v.show();
		}
	}
